...
**「なぜpushしただけで公開されるのか」「設定画面の各項目は何のためにあるのか」**
は、[23_vercel.md](./23_vercel.md) で解説しています。

登録しただけで中身が分かっていない、という状態が気持ち悪い人は、
**この章を終えたら 23章 を読んでください。**
Webhook・ビルド・エッジ配信・環境変数の反映タイミングなど、
ここで「よく分からないまま押した」ことの意味が全部つながります。
...
→ [19_testing.md](./19_testing.md)(仕組みを先に知りたい人は [23_vercel.md](./23_vercel.md) へ)
